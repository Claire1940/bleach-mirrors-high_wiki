...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - BLEACH Mirrors High Wiki',
    description: 'Copyright and intellectual property information for BLEACH Mirrors High Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - BLEACH Mirrors High Wiki',
      description: 'Copyright and intellectual property information for BLEACH Mirrors High Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 BLEACH Mirrors High Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of BLEACH Mirrors High Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Series Assets and Trademarks</h3>
            <p>
              BLEACH Mirrors High Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Shueisha</strong> - Publisher of the Bleach manga</li>
              <li><strong>Studio Pierrot</strong> - Animation studio behind the Bleach anime</li>
            </ul>
            <p>
            ...
            <p>
              The use of series assets and copyrighted materials on this website falls under fair use principles as
              outlined in Section 107 of the U.S. Copyright Act. Our use is:
            </p>
            <ul>
              <li><strong>Non-commercial:</strong> We do not directly monetize series assets or content</li>
              <li><strong>Transformative:</strong> We provide guides, analysis, and community resources</li>
              <li><strong>Educational:</strong> We help fans learn and understand the series</li>
              <li><strong>Minimal impact:</strong> Our use does not substitute for or harm the original game</li>
            </ul>
            <p>
              We believe our use of copyrighted materials enhances the fan experience and serves the community
            ...
            <ul>
              <li><strong>BLEACH</strong> - Series by Tite Kubo, published by Shueisha</li>
              <li><strong>Bleach</strong> - Series by Tite Kubo, published by Shueisha</li>
              <li><strong>BLEACH Mirrors High Wiki</strong> - Our own branding (not affiliated with the series)</li>
            </ul>
            <p>
              ...
              affiliation with BLEACH Mirrors High Wiki.
            </p>
            ...
            <p>
              ...
              BLEACH Mirrors High Wiki<br />
              Email: <a href="mailto:dmca@bleach-mirrors-high.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@bleach-mirrors-high.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "BLEACH Mirrors High Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: BLEACH Mirrors High Wiki (bleach-mirrors-high.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@bleach-mirrors-high.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@bleach-mirrors-high.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@bleach-mirrors-high.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@bleach-mirrors-high.wiki</a>
            </p>
            <p>
