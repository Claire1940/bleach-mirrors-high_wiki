...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - BLEACH Mirrors High Wiki",
    description: "Read the Terms of Service for BLEACH Mirrors High Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our anime and manga resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - BLEACH Mirrors High Wiki",
      description: "Terms and conditions for using BLEACH Mirrors High Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using BLEACH Mirrors High Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using BLEACH Mirrors High Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and BLEACH Mirrors High Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              BLEACH Mirrors High Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Bleach anime and manga. Our services include, but are not limited to:
            </p>
            <ul>
              <li>Character guides and arc breakdowns</li>
              <li>Zanpakuto and ability references</li>
              <li>Faction and organization guides</li>
              <li>Hollow and battle encyclopedias</li>
              <li>Episode and chapter guides</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> BLEACH Mirrors High Wiki is NOT affiliated with, endorsed by, or associated with
              Tite Kubo, Shueisha, Studio Pierrot, and VIZ Media or the official creators of Bleach. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by BLEACH Mirrors High Wiki and are protected by international
              copyright, trademark, and other intellectual property laws.
            </p>

            <h3>4.2 Game Content</h3>
            <p>
              All series-related content, including but not limited to character images, anime screenshots, logos, and
              trademarks, are the property of Tite Kubo, Shueisha, Studio Pierrot, and VIZ Media and/or the creators of Bleach. We use such
            ...
            <ul>
              ...
              <li><strong>Content Availability:</strong> Anime and manga release schedules may change without notice. We are not responsible for content availability on official streaming or publishing platforms.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, BLEACH MIRRORS HIGH WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including Reddit, VIZ Media, social media platforms,
            ...
            <p>
              ...
              you and BLEACH Mirrors High Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@bleach-mirrors-high.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@bleach-mirrors-high.wiki</a>
            </p>
            <p>
